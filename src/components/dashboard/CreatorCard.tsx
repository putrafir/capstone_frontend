...
export default function CreatorCard({ creator, onToggleSave, onViewRateCard }: CreatorCardProps) {
  ...
  // Tutup Rate Card lalu buka Chat — tidak ada modal bertumpuk
  ...
  return (
    <>
      ...
      {/* Chat Modal — reuse persis seperti MessagesSection & campaigns/[id] */}
      {chatOpen && (
        <ChatModal
